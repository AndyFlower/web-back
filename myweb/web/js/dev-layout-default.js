...
var dev_layout_alpha_content = {
    ...
    footer_buttons: function (settings) {
        ...
        $(".dev-page-footer-buttons").css({
            width: buttonsWidth,
            "margin-left": -buttonsWidth / 2
        }).addClass("dev-page-footer-buttons-effect");
        /* ./footer buttons width control */
    },
            ...
            if ($(contentID).length > 0) {
                ...
                setTimeout(function () {
                    ...
                    $(contentID).mCustomScrollbar({
                        ...
                        scrollInertia: 200,
                        advanced: {autoScrollOnFocus: false, autoExpandHorizontalScroll: true}
                    });
