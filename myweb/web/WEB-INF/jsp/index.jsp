...
<!-- //real-time-updates -->
<!-- error-graph -->
<script language="javascript" type="text/javascript" src="<%=basePath%>js/jquery.flot.errorbars.js"></script>
<script language="javascript" type="text/javascript" src="<%=basePath%>js/jquery.flot.navigate.js"></script>
<script type="text/javascript">
    $(function() {
...
<script src="<%=basePath%>js/svg-donut-chart-framework.js"></script>
<script type="text/javascript">
