...
public class RedEnvelopesDemo {
    ...
    public static void main(String[] args) {
        ...
        List<Integer> reds = dd.splitRedPackets(2000, 50);
        BigDecimal total = BigDecimal.ZERO;
        for (int i=0;i<reds.size();i++) {
            total = total.add(new BigDecimal(reds.get(i)));
            System.out.print(new BigDecimal(reds.get(i)).divide(new BigDecimal(100))+" ");
        }
        System.out.println(total);
        //单位是分
        //System.out.println(dd.splitRedPackets(18888, 50));
    }
}
